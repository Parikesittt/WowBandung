...
import com.example.testtubesmanual.databinding.FragmentWisataShopBinding
 ...
 * Use the [WisataShopFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WisataShopFragment : Fragment() {
    private var _binding: FragmentWisataShopBinding?= null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWisataShopBinding.inflate(inflater,container,false)
        return binding?.root
    }
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for (destinationSnap in snapshot.children){
                        ...
                        if (destination != null && destination.kategori == "belanja") {
                            destinationList.add(destination)
                        }
                    }
                }
                val rvAdapter = WisataAdapter(destinationList)
                binding?.rvWisataShop?.adapter = rvAdapter
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment WisataShopFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WisataShopFragment().apply {
